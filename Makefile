...
OBJS = msxmap.o ps2handl.o dbasemgt.o get_intelhex.o sys_timer.o serial_no.o cdcacm.o serial.o hr_timer.o SpecialFaultHandlers.o newlib_warning_fix.o database.o
